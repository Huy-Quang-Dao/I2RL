...
class DQN():
    ...
    def train(self, episodes, render=False):
        ...
        # Save policy
        torch.save(policy_dqn.state_dict(), "DQN\\cartpole_dql3.pt")
        ...
        # Save plots
        plt.savefig("DQN\\cartpole_dql3.png")
    ...
    def test(self, episodes,render=True, is_slippery=False):
        ...
        # Load learned policy
        policy_dqn = Net(in_states=num_states, h1_nodes=64,h2_nodes=32, out_actions=num_actions)
        policy_dqn.load_state_dict(torch.load("DQN\\cartpole_dql3.pt"))
