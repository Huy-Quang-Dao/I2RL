...
class Net(nn.Module):
    def __init__(self, input_shape, out_actions):
        ...
        self.conv_block1 = self._make_block(input_shape,10)
        self.conv_block2 = self._make_block(10,10)
...
class DQN():
    ...
    def train(self, episodes, render=False, is_slippery=False):
        ...
        policy_dqn = Net(input_shape=3, out_actions=num_actions)
        target_dqn = Net(input_shape=3, out_actions=num_actions)
